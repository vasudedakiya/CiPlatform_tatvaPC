        ...
        E = function() {
            ...
            return t = e, o = [{
                ...
                value: function() {
                    ...
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = this.placeholder;
                    else {
                        ...
                        //else if (s.innerHTML = this.placeholder) {
                        ...
                        //        else if (o) s.innerHTML = "", this.$valueTags = s.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr();
                        //        else {
